...
const val ANGLE_360_DEGREES: Angle = 360.0
const val ANGLE_180_DEGREES: Angle = 180.0
const val ANGLE_90_DEGREES: Angle = 90.0
...
const val LONGITUDE_FULL_CIRCLE = ANGLE_360_DEGREES
